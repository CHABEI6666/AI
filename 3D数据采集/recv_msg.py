...
class Mqtt_Clt():
    ...
    def __init__(self, ip_broker, port_broker, topic_sub, topic_pub, time_out_secs):
        ...
        """
        self.mqtt_clt = mqtt.Client(callback_api_version=mqtt.CallbackAPIVersion.VERSION2)  # 构造Mqtt客户端
...
if __name__ == '__main__':
    ...
    t_get_msg = threading.Thread(target=get_message, args=[mqtt_client.mqtt_queue])
    t_get_msg.start()
