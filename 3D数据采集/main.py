...
RAW_DATA_FOLDER = './dataset_try/raw'
RIPE_DATA_FOLDER = './dataset_try/ripe'
HALF_DATA_FOLDER = './dataset_try/half-ripe'
...
get_data = GetData('127.0.0.1', 21883, 'bb', 'aa', 60, RAW_DATA_FOLDER)
